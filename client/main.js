...
adminNav = adminNav.concat([
    ...
    {
        route: 'posts_natural_icon',
        label: 'Add natural icon to post'
    }
]);

// Sort postModules array position using modulePositions as index
postModules = _.sortBy(postModules, function (module) {
    return _.indexOf(modulePositions, module.position)
});

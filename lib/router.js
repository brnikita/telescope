...
PostsNaturalController = PostsListController.extend({
    view: 'new',
    template: getTemplate('posts_natural_icon')
});
...
Meteor.startup(function () {
    ...
    Router.map(function () {
        ...
        //
        this.route('posts_natural_icon', {
            path: 'posts_natural_icon',
            controller: PostsNaturalController
        });
